...
root_tree2 = TreeNode(4)
root_tree2.left = TreeNode(2)
root_tree2.right = TreeNode(6)
root_tree2.left.left = TreeNode(1)
root_tree2.left.right = TreeNode(3)
root_tree2.right.left = TreeNode(5)
root_tree2.right.right = TreeNode(7)