...
def main():
    ...
    #test case
    print(is_letter_constructible_from_magazine('asdf', 'sdfaasdfqwer'))
    print(is_letter_constructible_from_magazine('asdfz', 'sdfaasdfqwer'))
    print(is_letter_constructible_from_magazine_pythonic('asdf', 'sdfaasdfqwer'))
